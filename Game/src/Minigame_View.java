...
public class Minigame_View extends JFrame {
	...
	public void simonpanel(String target) { // overloaded constructor to set instance variables at instantiation.
		imgSimon.setIcon(new ImageIcon("src/" + target));
	}
	...
	public static JLabel lblWelcome, lblLives, lblScore, lblFood, lblPlayer, lblSimon,lblfnlScore, imgPlayer, imgSimon;
	...
	private void Boardpnl() {
		...
		lblLives = new JLabel("Lives: " + String.valueOf(3));
		lblLives.setBounds(10, 10, 123, 21);
		boardPnl.add(lblLives);
		
		lblScore = new JLabel("Score: " + String.valueOf(0));
		...
		upbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Minigame_process.setPlayer("up.png");
			}
		});
		boardPnl.add(upbtn);
		...
		downbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Minigame_process.setPlayer("down.png");
			}
		});
		...
		leftbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Minigame_process.setPlayer("left.png");
			}
		});
		...
		rightbtn.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Minigame_process.setPlayer("right.png");
			}
		});
		boardPnl.add(rightbtn);
	}
	
	public static void DecreaseLives(int L) {
		lblLives.setText("Lives: " + String.valueOf(L));
		
	}
	public static void IncreaseScore(int S) {
		lblScore.setText("Score: " + String.valueOf(S));
	}
	...
	private void endpnl() {
		...
		lblfnlScore = new JLabel("Your final Score: ");
		lblfnlScore.setBounds(10, 10, 123, 21);
		endPnl.add(lblfnlScore);
		 
		 
		
		
	}
	public void endlbl(int score) {
		lblfnlScore.setText("Your final Score:  " + score);
	}
